...
<div class="container">
    ...
    <div class="row justify-content-center" >
        ...
        <div class="col-md-6 " style="background: aliceblue; padding: 20px; border-radius: 10px; margin-top: 50px;">
            <h1 class="text-center" style="margin-top: 15px; color: black; padding: 10px;">Login Form</h1>
            <form action="../insert.php" enctype="multipart/form-data" method="post">

                <!-- Password input -->
                <div class="form-outline mb-4">
                    <label class="form-label" for="form2Example2" style="color: black">Employee name</label>
                    <input type="text" name="name" id="form2Example2" class="form-control" />
                </div>
